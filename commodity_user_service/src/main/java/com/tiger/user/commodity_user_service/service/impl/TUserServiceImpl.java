...
public class TUserServiceImpl extends ServiceImpl<TUserMapper, TUser> implements ITUserService {
    ...
    public  BaseResponseVO whereUserName(TUser user) {
        ...
        if(tUser==null)
        {
         return new BaseResponseVO(ResponseCode.ERROR_601.getCode().toString(),ResponseCode.ERROR_601.getMessage().toString());
        }
        if(!tUser.getPassword().equals(user.getPassword())){

            return new BaseResponseVO(ResponseCode.ERROR_602.getCode().toString(),ResponseCode.ERROR_602.getMessage().toString());
        }
        return  new BaseResponseVO((ResponseCode.SUCCESS_200.getCode().toString()),ResponseCode.SUCCESS_200.getMessage().toString());
    }
}
